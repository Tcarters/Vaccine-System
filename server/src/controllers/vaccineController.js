...
exports.create = async (req, res ) => {
    try {
        ...
        console.log('Error create vaccine', err);
...
exports.getAll = async( req, res) => {
    try {
        ...
        console.log('Error  getAll vaccine', err);
        res.status(500).json(err);
    }
}
...
exports.getOne = async( req, res) => {
    try {
        ...
        console.log('Error get One vaccine:', err);
        res.status(500).json(err);
    }
}
...
exports.update = async (req, res) => {
    try {
        ...
        console.log('Error Update vaccine:', err);
        res.status(500).json(err);
    }
}
...
exports.delete = async (req, res) => {
    try {
        ...
        res.status(200).json('Vaccine Deleted! ');
    } catch(err) {
        console.log('Error Deleting vaccine:', err);
        res.status(500).json(err);
    }
}